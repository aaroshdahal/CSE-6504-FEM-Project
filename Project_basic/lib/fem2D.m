...
for iTraction = 1 : Model.nTractionForce
    ...
    f = thickness * elemEquivalentLoad(edgeCoord, load);
...
for iElem = 1 : nElem
    ...
    for ip = 1:nPts
        ...
        epsilon(3) = epsilon(3)/2;          % printing true shear instead of engineering shear
...
Results.coordinates = coordinates;   % nNode×nDim
Results.elements    = elements;      % nElem×nElemNode
Results.nDim        = nDim;          % scalar
Results.nElemNode   = nElemNode;     % scalar
